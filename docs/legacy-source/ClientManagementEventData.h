...
class BLXWARE_API CClientManagementEventData
	: public CBaseClientPacketDataSync
	,public CBlxHeap2< CClientManagementEventData >
{
	friend class CBlxHeap2< CClientManagementEventData >;

public:
	CClientManagementEventData( );
	CClientManagementEventData( UINT32 BufferLength );
	~CClientManagementEventData();
